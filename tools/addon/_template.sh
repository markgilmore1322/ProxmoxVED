...
source <(curl -fsSL https://raw.githubusercontent.com/markgilmore1322/ProxmoxVED/main/misc/core.func)
source <(curl -fsSL https://raw.githubusercontent.com/markgilmore1322/ProxmoxVED/main/misc/tools.func)
...
source <(curl -fsSL https://raw.githubusercontent.com/markgilmore1322/ProxmoxVED/main/misc/tools.func) 2>/dev/null || {
