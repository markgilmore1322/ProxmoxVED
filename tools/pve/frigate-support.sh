...
# License: MIT
# https://github.com/markgilmore1322/ProxmoxVED/raw/main/LICENSE
...
# bash -c "$(curl -fsSL https://github.com/markgilmore1322/ProxmoxVED/raw/main/misc/frigate-support.sh)"
