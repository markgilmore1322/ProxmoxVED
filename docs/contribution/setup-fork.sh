...
# upstream   https://github.com/markgilmore1322/ProxmoxVED.git (fetch)
# upstream   https://github.com/markgilmore1322/ProxmoxVED.git (push)
```
...
print_info "Upstream: https://github.com/markgilmore1322/ProxmoxVED"
echo ""
